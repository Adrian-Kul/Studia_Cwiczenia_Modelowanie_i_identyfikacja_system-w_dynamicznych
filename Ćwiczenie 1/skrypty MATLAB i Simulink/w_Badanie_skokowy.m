...
title('Odpowiedü impulsowa zdyskretyzowanego uk≥adu metodπ skokowπ');

figure
plot(tt_st,yr_st,t_st_imp,y_st_imp,'LineWidth',2);
title('Odpowiedü skokowa zdyskretyzowanego uk≥adu metodπ skokowπ');

figure
plot(tt_ln,yr_ln,t_ln_imp,y_ln_imp,'LineWidth',2);
title('Odpowiedü na sygna≥ liniowo narastajπcy zdyskretyzowanego uk≥adu metodπ skokowπ');